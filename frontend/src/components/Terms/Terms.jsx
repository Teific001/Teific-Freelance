          ...
          <div className="w-full px-10 md:w-1/2 flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-10">
              <div className="">
                ...
                <p>
                  This website is operated by Teific Technology Pvt. Ltd.
                  Throughout the site, the terms “we”, “us” and “our” refer to
                  Teific Technology Pvt. Ltd. Teific Technology Pvt. Ltd. offers
              ...
              <div>
                ...
                <p>
                  ...
                  or province of residence, and you have given us your consent
              ...
              <div>
                ...
                <p>
                  ...
                  the same billing and/or shipping address. If we make a change
                  to or cancel an order, we may attempt to notify you by
                  contacting the e-mail and/or billing address/phone number
                  provided at the time the order was made. We reserve the right
              ...
              <div>
                ...
                <p>
                  n addition to other prohibitions as set forth in the Terms of
              ...
              <div>
                ...
                <p>
                  ...
                  <br /> <br />
                  In no case shall{" "}
                  <span className="text-[#FBC93ECC] font-bold">
                    {" "}
                    Teific Technology Pvt. Ltd.
                  </span>
                  ...
                  be limited to the maximum extent permitted by l
                </p>
              </div>
              <div>
                <h3 className="text-[#FBC93ECC] font-bold text-3xl">
                ...
                <p>
                  You agree to indemnify, defend and hold harmless **Teific
                  Technology Pvt. Ltd.** and our parent, subsidiaries,
              ...
              <div>
                ...
                <p>
                Questions about the Terms of Service should be sent to us at <span className="font-bold text-[#FBC93ECC] ">support@teific.in</span> .
                </p>
              </div>
